      ...
      <div className="container px-4 mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 font-display">
            Go from Term Sheet to Tokenised Debt in Days, Not Months
          </h2>
          ...
          <Button 
            className="bg-white text-vayana-blue hover:bg-white/90 px-8 py-3 text-lg font-medium rounded-lg inline-flex items-center gap-2"
            onClick={() => {
