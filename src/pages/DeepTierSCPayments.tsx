          ...
          <div className="max-w-6xl mx-auto mb-12">
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-4 md:p-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                <img src="/lovable-uploads/40cbf9f8-c601-47f9-a143-7e5611ea1eda.png" alt="Deep-Tier Supply Chain Payments Flow Diagram" className="w-full h-auto max-w-full mx-auto rounded-lg" />
              </div>
